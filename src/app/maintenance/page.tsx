  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        {/* Animated Moving Light Ball */}
        <div 
          className="absolute w-[600px] h-[600px] rounded-full animate-ball-screen-move opacity-30 mix-blend-screen"
          style={{
            background: 'radial-gradient(circle, rgba(59,130,246,0.7) 0%, rgba(37,99,235,0.3) 50%, transparent 75%)',
            filter: 'blur(80px)',
          }}
        />
            ...
            <div className="mb-8 relative animate-float">
              ...
              <div className="relative flex items-center justify-center">
                <div className="relative h-14 w-14">
                  <Hammer 
                    className="absolute top-0 right-0 w-8 h-8 text-slate-300 -rotate-12 transform-gpu drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]" 
                    strokeWidth={1.5}
                  />
                  <Wrench 
                    className="absolute bottom-0 left-0 w-8 h-8 text-blue-400 rotate-45 transform-gpu drop-shadow-[0_0_15px_rgba(59,130,246,0.5)]" 
                    strokeWidth={1.5}
                  />
                </div>
              </div>
