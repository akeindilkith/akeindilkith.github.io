    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        <Card className="bg-white/5 border-white/10 backdrop-blur-xl shadow-2xl">
          <CardContent className="flex flex-col items-center pt-12 pb-10 px-8 text-center">
            ...
            <div className="mb-10 relative animate-float">
              ...
              <div className="relative flex items-center justify-center">
                <div className="relative h-20 w-20">
                  <Hammer 
                    className="absolute top-0 right-0 w-12 h-12 text-slate-300 -rotate-12 transform-gpu drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]" 
                    strokeWidth={1.5}
                  />
                  <Wrench 
                    className="absolute bottom-0 left-0 w-12 h-12 text-blue-400 rotate-45 transform-gpu drop-shadow-[0_0_20px_rgba(59,130,246,0.5)]" 
                    strokeWidth={1.5}
                  />
                </div>
              </div>
            ...
            <div className="space-y-4 mb-10">
              ...
              <div className="space-y-2">
                ...
                <p className="text-slate-500 text-sm">
                  The terminal is currently undergoing scheduled optimization.
                </p>
              </div>
            </div>

            {/* Working Badge */}
            <div className="inline-flex items-center gap-2.5 px-5 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 group hover:border-blue-500/40 transition-colors">
        ...
        {year && (
          <footer className="mt-8 text-center text-[10px] text-slate-600 uppercase tracking-[0.3em] opacity-60">
