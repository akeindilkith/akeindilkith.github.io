      ...
      <div className="relative z-10 w-full max-w-[400px]">
        <Card className="bg-white/5 border-white/10 backdrop-blur-2xl shadow-2xl rounded-[3rem] overflow-hidden">
          <CardContent className="flex flex-col items-center pt-12 pb-10 px-10 text-center">
            ...
            <div className="mb-10 relative animate-float">
              ...
              <div className="relative flex items-center justify-center">
                <div className="relative h-16 w-16">
                  <Hammer 
                    className="absolute top-0 right-0 w-10 h-10 text-slate-300 -rotate-12 transform-gpu drop-shadow-[0_0_12px_rgba(255,255,255,0.4)]" 
                    strokeWidth={1.5}
                  />
                  <Wrench 
                    className="absolute bottom-0 left-0 w-10 h-10 text-blue-400 rotate-45 transform-gpu drop-shadow-[0_0_18px_rgba(59,130,246,0.6)]" 
                    strokeWidth={1.5}
                  />
                </div>
              </div>
            ...
            {/* Working Badge */}
            <div className="inline-flex items-center gap-2.5 px-6 py-2.5 rounded-full bg-blue-500/10 border border-blue-500/20">
